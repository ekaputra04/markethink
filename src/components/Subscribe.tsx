...
export default function Subscribe() {
  return (
    <>
      <div className="relative px-8 md:px-16 lg:px-32 py-24">
        <div className="relative space-y-8 bg-gradient-to-br from-[#395C4D] to-[#132D1F] p-32 w-full overflow-hidden">
          <img
          ...
          <img
            ...
            alt="decorator"
            className="-top-16 left-0 z-20 absolute h-72 rotate-180"
          />
        ...
        <img
          ...
          alt="decorator"
          className="right-8 bottom-8 z-20 absolute w-72"
        />
      </div>
    </>
  );
